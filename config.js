...
module.exports = {
  ...
  //_________________________________________________________________________________________________________________________________
  SUDO: process.env.SUDO || "919539901834",
  //_________________________________________________________________________________________________________________________________
  ...
  BRANCH: "main",
  //_________________________________________________________________________________________________________________________________
  STICKER_DATA: "9ine.x3;@false_eye",
  //_________________________________________________________________________________________________________________________________
  ...
  //_________________________________________________________________________________________________________________________________
  OWNER_NAME: process.env.OWNER_NAME || "𝒇𝒂𝒍𝒔𝒆 𝒆𝒚𝒆",
  //_________________________________________________________________________________________________________________________________
  OWNER_NUMBER: process.env.OWNER_NUMBER || "919539901834",
  //_________________________________________________________________________________________________________________________________
  BOT_NAME: process.env.BOT_NAME || "9ine.x3",
  //_________________________________________________________________________________________________________________________________
  WORK_TYPE: process.env.WORK_TYPE || "public",
  //_________________________________________________________________________________________________________________________________
  BASE_URL: "https://t.me/sarca_stics",
  //_________________________________________________________________________________________________________________________________
  //Database
  DATABASE:
